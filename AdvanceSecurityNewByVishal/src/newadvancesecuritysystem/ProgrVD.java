...
class ProgrVD extends JFrame  implements Runnable
{
        ...
        public void run()
             {
                    ...
                    for(int x= min; x <= max; x++)
                    {
                            ...
                            this.dispose();
                            JOptionPane.showMessageDialog(null, "The Video was Decoded Successfully!","Success!", JOptionPane.INFORMATION_MESSAGE);
                            midd.createPlayer();
                            midd.show(true);
                   }
      public static void main(String ar[])
      {
       ProgrVD bg = new ProgrVD();
       }


}
class MediaTabrD extends JFrame
 {
