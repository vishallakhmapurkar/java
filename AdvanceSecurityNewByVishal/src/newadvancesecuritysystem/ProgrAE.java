...
class ProgrAE extends JFrame  implements Runnable
{
        ...
        public void run()
             {
                    ...
                    for(int x= min; x <= max; x++)
                    {
                            ...
                            this.dispose();
                            JOptionPane.showMessageDialog(null, "The Song was encoded Successfully!","Success!", JOptionPane.INFORMATION_MESSAGE);
                            aud.createPlayer();
                            aud.show(true);
                   }
      public static void main(String ar[])
      {
       ProgrAE bg = new ProgrAE();
       }


}
class AudioTabr extends JFrame
 {
	  Player player;
	  File file;
	 Audio_Filter af;
